...
import gestion.packages.configuration.JwtService;
import gestion.packages.entities.User;
import gestion.packages.repositories.UserRep;
import gestion.packages.token.Token;
import gestion.packages.token.TokenRepository;
import gestion.packages.token.TokenType;
...
public class AuthService {
	...
	public AuthResponse register(RegisterRequest request) {
		var user = User.builder().prenom(request.getPrenom()).nom(request.getNom()).email(request.getEmail())
